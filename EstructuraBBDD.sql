...
INSERT INTO Usuarios (u_username, u_nombre, u_correo, u_password) values('aalgarra', 'Alejandro Algarra Delgado', 'algarra.delgado.alejandro@alumnat.copernic.cat', '123');
INSERT INTO Usuarios (u_username, u_nombre, u_correo, u_password) values('amorales', 'Alex Morales Luna', 'morales.luna.alex@alumnat.copernic.cat', '123');
INSERT INTO Usuarios (u_username, u_nombre, u_correo, u_password) values('mfreixa', 'Max Freixa Abcd', 'freixa.abcd.max@alumnat.copernic.cat', '123');
